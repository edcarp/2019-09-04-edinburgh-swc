...
humandate: "4-5 Sep 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["David McKain", "Chris Wood", "Antonia Mey", "Ruairidh MacLeod"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["David McKain", "Antonia Mey", "Ruairidh MacLeod", "Matt Addams", "Felicity Anderson", "Fiona Bissett", "Keith Brunton", "Magnus Hagdorn", "Salome Llabres", "Lucia Michielin", "Barry O'Rourke", "Linus Schumacher", "Matthew Hamilton"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["david.mckain@ed.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:    https://pad.carpentries.org/2019-09-04-edinburgh-swc          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
